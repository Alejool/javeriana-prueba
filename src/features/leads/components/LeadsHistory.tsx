                ...
                <div className="space-y-4">
                  {leads.map((lead) => (
                    <motion.div
                      ...
                      className="bg-white dark:bg-neutral-900 p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex flex-col sm:flex-row justify-between gap-4"
                    >
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <p className="font-bold text-neutral-900 dark:text-neutral-100 font-headline">
                            {lead.fullName}
                          </p>
                          <span className="text-[10px] px-2 py-0.5 rounded-full bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300 font-bold uppercase tracking-wider">
                      ...
                      <div className="flex sm:flex-col justify-between items-end gap-2 border-t sm:border-t-0 sm:border-l border-neutral-100 dark:border-neutral-800 pt-3 sm:pt-0 sm:pl-4">
